...
action = input('Digite 1 para salvar um nova senha ou 2 para ver uma senha salva: ')
...
match action:
    case '1':
        if len(Password.get()) == 0:
            ...
            if path:
                print('Chave salva no arquivo, lembre-se de remover após o transferir de local')
    ...
    case '2':
        ...
        if password:
            ...
            print('Nenhma senha encontrada para o domínio')
